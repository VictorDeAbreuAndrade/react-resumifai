...
app.post("/summary/:id", async (req, res) => {
  ...
  try {
    ...
    const prompt = `Sum up the text below. Keep the important information and respect the limit of 200 words. Finally, keep the summary in the same language as the text. That's the text:\n\n${transcription}`;
